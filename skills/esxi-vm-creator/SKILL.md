...
```bash
# 单个 IP
python check_ip.py --ip 192.168.1.190

# 多个 IP
python check_ip.py --ips 192.168.1.190,192.168.1.191
```
...
```bash
# 同步模式（等待完成）
python esxi_vm_creator.py --esxi 192.168.0.3 --yaml "..."

# 异步模式（触发后立即返回）
python esxi_vm_creator.py --esxi 192.168.0.3 --yaml "..." --async
```
